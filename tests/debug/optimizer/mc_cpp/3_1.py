...
def run_monte_carlo(num_sims=NUM_SIMS, seed=310, rate_std=0.0):
...
def parse_args():
    ...
    parser.add_argument("--seed", type=int, default=310, help="Random seed for initial angular rates.")
    parser.add_argument("--rate-std", type=float, default=0.01, help="Initial angular-rate 1-sigma perturbation [rad/s].")
...
def main():
    ...
    if args.save_dir is not None:
        ...
        figs[0].savefig(args.save_dir / "3_1_spaghetti.png", dpi=150)
        figs[1].savefig(args.save_dir / "3_1_mean_sigma.png", dpi=150)
