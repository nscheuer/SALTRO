...
def parse_args():
    ...
    parser.add_argument("--seed", type=int, default=330, help="Random seed for initial angular rates.")
...
def main():
    ...
    if args.save_dir is not None:
        ...
        figs[0].savefig(args.save_dir / "3_3_spaghetti.png", dpi=150)
        figs[1].savefig(args.save_dir / "3_3_mean_sigma.png", dpi=150)
