...
TEST_CASE("igrf13 dimensions and validity", "[magnetic][igrf13]")
{
    constexpr int N = 5;
    ...
    bool ok = orbits::compute_magnetic_igrf13(R, jtime, N, B);
    REQUIRE(ok);
...
TEST_CASE("igrf13 magnitude sanity in LEO", "[magnetic][igrf13]")
{
    constexpr int N = 3;
...
TEST_CASE("igrf13 circular orbit smoothness", "[magnetic][igrf13]")
{
    constexpr int N = 60;
