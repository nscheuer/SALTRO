...
TEST_CASE("Sun nrelspa dimensions and validity", "[sun][nrelspa]")
{
    constexpr int N = 5;
    ...
    bool ok = orbits::compute_sun_nrelspa(R, jtime, N, S);
    REQUIRE(ok);
...
TEST_CASE("Sun nrelspa unit direction vectors", "[sun][nrelspa]")
{
    constexpr int N = 10;
    const double Re = 6378136.3;
...
TEST_CASE("Sun nrelspa time variation smooth", "[sun][nrelspa]")
{
    constexpr int N = 50;
    const double Re = 6378136.3;
...
TEST_CASE("Sun nrelspa circular orbit consistency", "[sun][nrelspa]")
{
    constexpr int N = 60;
    const double Re = 6378136.3;
