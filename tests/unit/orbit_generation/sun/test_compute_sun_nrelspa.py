...
def test_sun_nrelspa_dimensions_and_validity():
    N = 5
    Re = 6378136.3
    ...
    ok, S = saltro_py.compute_sun_nrelspa(R, jtime)
...
def test_sun_nrelspa_unit_vectors():
    N = 10
    Re = 6378136.3
...
def test_sun_nrelspa_time_variation_smooth():
    N = 50
    Re = 6378136.3
...
def test_sun_nrelspa_circular_orbit_consistency():
    N = 60
    Re = 6378136.3
    alt = 400e3
    r = Re + alt
