...
py::tuple compute_density_harrispriester_py(
...
void bind_compute_density_harrispriester(py::module_& m)
{
    m.def(
        "compute_density_harrispriester",
        &compute_density_harrispriester_py,
        py::arg("R"),
        py::arg("S"),
        R"doc(
Compute atmospheric density using Harris–Priester model.
