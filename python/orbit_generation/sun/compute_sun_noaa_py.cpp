...
)
{
    ...
    const bool ok = saltro::orbits::compute_sun_noaa(
        R,
        jtime,
        N,
        S
...
void bind_compute_sun_noaa(py::module_& m)
{
    m.def(
        "compute_sun_noaa",
        &compute_sun_noaa_py,
        ...
        py::arg("jtime"),
        R"doc(
Compute Sun vector along trajectory using NOAA model.
