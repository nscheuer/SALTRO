...
py::tuple compute_orbit_J2_RK4_py(
...
)
{
    ...
    const bool ok = saltro::orbits::compute_orbit_J2_RK4(
        r0,
        v0,
        jtime,
        N,
...
void bind_compute_orbit_J2_RK4(py::module_& m)
{
    m.def(
        "compute_orbit_J2_RK4",
        &compute_orbit_J2_RK4_py,
        py::arg("r0"),
        py::arg("v0"),
        py::arg("jtime"),
        R"doc(
Propagate orbit using J2 perturbation model with RK4 integration.
